      ...
      <div className="w-full max-w-[1200px] mx-auto px-6">
        ...
        {loading ? (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="p-6 bg-cosmos-surface border border-cosmos-border rounded-2xl space-y-4">
                <div className="skeleton-shimmer w-12 h-12 rounded-xl bg-cosmos-surface-elevated" aria-hidden />
                ...
                <div className="skeleton-shimmer rounded h-6 w-16 bg-cosmos-surface-elevated" aria-hidden />
              </div>
            ))}
          </div>
        ) : (
